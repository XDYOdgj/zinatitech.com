		...
		var e = {
				855: (e, t, n) => {
					...
					function o(e) {
						for (var t = 1; t < arguments.length; t++) {
							...
							t % 2 ? r(Object(n), !0).forEach((function(t) {
								...
								Object.getOwnPropertyDescriptors(n)) : r(Object(n)).forEach((
								function(t) {
					...
					var s = "Sal was not initialised! Probably it is used in SSR.",
						...
						O = function() {
							var e = [].filter.call(document.querySelectorAll(l.selector), (function(
								e) {
								return ! function(e) {
						...
						g = function() {
							document.body.classList.remove(l.disabledClassName), u =
						...
						w = function() {
							...
							{};
							m(), Array.from(document.querySelectorAll(l.selector)).forEach(f), d(e),
								g()
						},
						j = function() {
							var e = O();
